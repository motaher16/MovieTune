...
public class Upcoming extends Fragment implements ApiResponse {
    ...
    private void loadNowPlayingMovies(int page) {
        ...
        String url = ApiDetails.BASE_URL + ApiDetails.UPCOMING_MOVIES_URL + "api_key=" + CommonData.API_KEY + "&page=" + page;
