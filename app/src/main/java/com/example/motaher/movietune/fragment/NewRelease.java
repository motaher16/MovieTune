...
public class NewRelease extends Fragment implements ApiResponse {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        rootView = inflater.inflate(R.layout.fragment_newrelease, container, false);
        initView(rootView);
        return rootView;
    }
    ...
    private void newRelease(int page) {
